...
<script>
    (function() {
        ...
        var blur = function() {
            btnBlur.textContent = 'Blur some more';
            /** {ImageData} */
            ...
            for (var i = 0, len = px.length; i < len; i++) {
                ...
                px[i] = (tmpPx[i] + (tmpPx[i - 4] || tmpPx[i]) + (tmpPx[i + 4] || tmpPx[i])) / 3;
                px[i] = (tmpPx[i] + (tmpPx[i - 4 * data.width] || tmpPx[i]) + (tmpPx[i + 4 * data.width] || tmpPx[i])) / 3;
            }
